...
internal class SuspendLambdaLowering(context: JvmBackendContext) : SuspendLoweringUtils(context), FileLoweringPass {
    override fun lower(irFile: IrFile) {
        irFile.transformChildrenVoid(object : IrElementTransformerVoidWithContext() {
            ...
            override fun visitBoundFunctionReference(expression: IrBoundFunctionReference): IrExpression {
    ...
    private fun generateAnonymousObjectForLambda(reference: IrBoundFunctionReference, parent: IrDeclarationParent) =
    ...
    private fun generateContinuationClassForLambda(reference: IrBoundFunctionReference, parent: IrDeclarationParent): IrClass =
