...
abstract class IrValidationPhase<Context : BackendContext>(val context: Context) : ModuleLoweringPass {
...
open class IrValidationBeforeLoweringPhase<Context : BackendContext>(context: Context) : IrValidationPhase<Context>(context) {
...
class IrValidationAfterInliningOnlyPrivateFunctionsPhase<Context : BackendContext>(
    context: Context,
