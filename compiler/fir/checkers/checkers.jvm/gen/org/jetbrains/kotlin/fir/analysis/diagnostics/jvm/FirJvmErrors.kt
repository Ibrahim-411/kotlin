...
object FirJvmErrors {
    ...
    val JVM_EXPOSE_BOXED_WITHOUT_INLINE: KtDiagnosticFactory0 = KtDiagnosticFactory0("JVM_EXPOSE_BOXED_WITHOUT_INLINE", ERROR, SourceElementPositioningStrategies.DEFAULT, KtAnnotationEntry::class)
