...
context(_: Int) fun regularFun(): String = ""
context(_: Int) fun regularFun(p1: Number): String = ""
context(_: Int) fun regularFun(p1: Int): String = ""
context(_: Int) fun regularFun(p1: Int, p2: Long): String = ""
context(_: Int) fun regularFun(p1: Number, p2: Long): String = ""
context(_: Int) fun regularFun(p1: Int, p2: Number): String = ""
context(_: Int) fun regularFun(p1: Number, p2: Number): String = ""
context(_: Int) fun Int.regularFun(): String = ""
context(_: Int) fun Long.regularFun(): String = ""
context(_: Int) fun Number.regularFun(): String = ""

context(_: Int, _: Long) fun regularFun(): String = ""
context(_: Int, _: Long) fun regularFun(p1: Number): String = ""
context(_: Int, _: Long) fun regularFun(p1: Int): String = ""
context(_: Int, _: Long) fun regularFun(p1: Int, p2: Long): String = ""
context(_: Int, _: Long) fun regularFun(p1: Number, p2: Long): String = ""
context(_: Int, _: Long) fun regularFun(p1: Int, p2: Number): String = ""
context(_: Int, _: Long) fun regularFun(p1: Number, p2: Number): String = ""
context(_: Int, _: Long) fun Int.regularFun(): String = ""
context(_: Int, _: Long) fun Long.regularFun(): String = ""
context(_: Int, _: Long) fun Number.regularFun(): String = ""
