...
object JsFrontendPipelineStep : CompilerPipelineStep<ConfigurationPipelineArtifact<K2JSCompilerArguments>, JsFrontendPipelineArtifact>() {
    override fun execute(input: ConfigurationPipelineArtifact<K2JSCompilerArguments>): StepStatus<JsFrontendPipelineArtifact> {
