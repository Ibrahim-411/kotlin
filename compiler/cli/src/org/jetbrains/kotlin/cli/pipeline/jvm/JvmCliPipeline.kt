...
class JvmCliPipeline(override val performanceManager: K2JVMCompilerPerformanceManager) : AbstractCliPipeline<K2JVMCompilerArguments>() {
    ...
    override fun isKaptMode(arguments: K2JVMCompilerArguments): Boolean {
        return arguments.useK2Kapt == true
    }
}
