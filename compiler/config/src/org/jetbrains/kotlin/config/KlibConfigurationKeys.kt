...
fun CompilerConfiguration.addKlibRelativePathBase(value: String) {
    add(KlibConfigurationKeys.KLIB_RELATIVE_PATH_BASES, value)
}

fun CompilerConfiguration.addKlibRelativePathBases(values: Collection<String>) {
    addAll(KlibConfigurationKeys.KLIB_RELATIVE_PATH_BASES, values)
}
