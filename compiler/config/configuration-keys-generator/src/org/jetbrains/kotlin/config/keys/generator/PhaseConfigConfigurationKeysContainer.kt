...
object PhaseConfigConfigurationKeysContainer : KeysContainer("org.jetbrains.kotlin.config", "PhaseConfigConfigurationKeys") {
    ...
    val PHASE_DUMP_DIRECTORY by key<String>("Dump the backend state into this directory")
    val PHASE_DUMP_ONLY_FQ_NAME by key<String>("Dump the declaration with the given FqName")
