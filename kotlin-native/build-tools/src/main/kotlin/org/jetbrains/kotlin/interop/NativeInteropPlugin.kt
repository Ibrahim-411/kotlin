...
open class NativeInteropPlugin : Plugin<Project> {
    override fun apply(target: Project) {
        ...
        val bindingsRoot = target.objects.directoryProperty()

        val nativeInteropPlugin = target.extensions.create<NativeInteropExtension>("nativeInteropPlugin", { applyFinish(target, bindingsRoot) })
        ...
        bindingsRoot.set(nativeInteropPlugin.usePrebuiltSources.flatMap {
