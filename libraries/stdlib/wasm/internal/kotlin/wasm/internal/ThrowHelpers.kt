...
@PublishedApi
internal fun throwUnsupportedOperationException(name: String): Nothing {
    throw UnsupportedOperationException("lateinit property $name has not been initialized")
}