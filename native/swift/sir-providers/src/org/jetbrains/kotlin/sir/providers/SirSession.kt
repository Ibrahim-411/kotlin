    ...
    SirChildrenProvider
{
    ...
    override fun KaDeclarationSymbol.sirDeclaration(): List<SirDeclaration> = with(declarationProvider) { this@sirDeclaration.sirDeclaration() }
...
public interface SirDeclarationProvider {
    public fun KaDeclarationSymbol.sirDeclaration(): List<SirDeclaration>
}
